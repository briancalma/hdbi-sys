...
<div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10"  x-data="{modalOpen: false, userId: null}">
    <!-- Breadcrumb Start -->
                    ...
                    @foreach($users as $user)
                        <div class="grid grid-cols-12 border-t border-[#EEEEEE] px-5 py-4 dark:border-strokedark lg:px-7.5 2xl:px-11">
                            ...
                            <div class="flex items-center space-x-3.5">
                                ...
                                <button class="hover:text-primary text-warning">
                                ...
                                <button @click="modalOpen=true;userId={{ $user->id }}" class="hover:text-primary text-danger">
                                    <svg class="fill-current" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div>
        <div x-show="modalOpen" x-transition="" class="fixed left-0 top-0 flex h-full min-h-screen w-full items-center justify-center bg-black/80 px-4 py-5">
