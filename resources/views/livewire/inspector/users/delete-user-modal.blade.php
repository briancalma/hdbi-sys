<div x-show="modalOpen && modal == 'confirm-deactivate-user-modal'" class="fixed left-0 top-0 flex h-full min-h-screen w-full items-center justify-center bg-black/80 px-4 py-5"
...
>
    <div @click.outside="modalOpen = false; modal = '';" class="w-full max-w-142.5 rounded-lg bg-white px-8 py-12 text-center dark:bg-boxdark md:px-17.5 md:py-15">
        ...
        <div class="-mx-3 flex flex-wrap gap-y-4">
            ...
            <div class="w-full px-3 2xsm:w-1/2">
                <button wire:click="deActivateUser(userId)" type="button" class="block w-full rounded border border-meta-1 bg-meta-1 p-3 text-center font-medium text-white transition hover:bg-opacity-90">
                    Deactivate
                </button>
            </div>
        </div>
