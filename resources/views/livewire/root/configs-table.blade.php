<div x-init="modalOpen = false;">
                        ...
                        <div wire:key="{{ $item->id }}" class="grid grid-cols-12 border-t border-[#EEEEEE] px-5 py-4 dark:border-strokedark lg:px-7.5 2xl:px-11">
                            ...
                            <div class="col-span-2">
                                <div class="flex flex-row gap-7">
                                    ...
                                    <button @click="modalOpen=true;configId={{ $item->id }}" class="hover:text-primary text-danger">
    ...
    <div x-show="modalOpen" class="fixed left-0 top-0 flex h-full min-h-screen w-full items-center justify-center bg-black/80 px-4 py-5">
        <div @click.outside="modalOpen = false" class="w-full max-w-142.5 rounded-lg bg-white px-8 py-12 text-center dark:bg-boxdark md:px-17.5 md:py-15">
            ...
            <div class="-mx-3 flex flex-wrap gap-y-4">
                ...
                <div class="w-full px-3 2xsm:w-1/2">
                    <!-- <button wire:click="deleteConfig(configId);modalOpen=false;" type="button" class="block w-full rounded border border-meta-1 bg-meta-1 p-3 text-center font-medium text-white transition hover:bg-opacity-90">
                        Delete
                    </button> -->
                    <button @click="$wire.deleteConfig(configId).then(() => modalOpen = false)" type="button" class="block w-full rounded border border-meta-1 bg-meta-1 p-3 text-center font-medium text-white transition hover:bg-opacity-90">
                        Delete
                    </button>
                </div>
            </div>
