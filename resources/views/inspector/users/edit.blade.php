...
<div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
    ...
    <form method="POST" action="{{ route('inspector.users.update', $user) }}">
        @csrf
        @method('PATCH')
        <div class="p-6.5">
            ...
            <div class="flex flex-row-reverse gap-2">
                ...
                <button type="submit" class="flex justify-center rounded bg-warning p-3 font-medium text-white hover:bg-opacity-90">
                    Update User
                </button>
            </div>
        </div>
